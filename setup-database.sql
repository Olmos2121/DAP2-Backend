-- Script de configuración completa para PostgreSQL
-- Ejecutar este script en PostgreSQL con el usuario Admin

-- Crear la base de datos si no existe
CREATE DATABASE "TP-DA2";
...
-- Insertar películas populares en español
...
-- Ver el estado final de las tablas
